...
Built 4 of 7 models (1 changed) against synthetic data · 25 tests · 0 convention issues · 3.8 s
...
Also rebuilt, no new issues: `stg_webshop__customers`, `stg_webshop__order_items`, `stg_webshop__orders`, `fct_order_items`.
