...
Built 4 of 7 models (1 changed) against synthetic data · 25 tests · 0 convention issues · 3.6 s
...
Also rebuilt, no new issues: `stg_webshop__orders`, `stg_webshop__order_items`, `stg_webshop__customers`, `fct_order_items`.
