...
Built 7 of 9 models (4 changed) against synthetic data · 41 tests · 0 convention issues · 9.4 s
...
Also rebuilt, no new issues: `dim_products`, `fct_order_items`, `fct_orders`, `int_orders__items_aggregated`.
